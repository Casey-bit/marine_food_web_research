...
def three(ax_three):
    ...
    ax_three.set_yticks([-0.06,-0.04,-0.02,0,0.02,0.04,0.06])

    ax_three.set_xticklabels(['1970-1982','1979-1991','1988-2000','1997-2009','2006-2018'],font1)
    ax_three.set_yticklabels(['6%','4%','2%','0%','2%','4%','6%'],font1)
    ax_three.set_xlabel('Year',font1)
    ax_three.set_xlim([1972,2017])
    ax_three.set_ylim([-0.08,0.08])
    ax_three.legend(prop = font2,ncol = 3,loc = 3,fontsize = 12, columnspacing = 0.5)
    set_axis(ax_three)
    ax_three.text(1973, -0.08 + (0.16) * 0.96, 'D', verticalalignment="top",
                horizontalalignment="left", fontdict=font4)
    ax_three.text(1975, -0.08 + (0.16) * 0.95, 'At the taxonomic level of order', verticalalignment="top",
    ...
    ax2.set_yticklabels(['0%','2.5%','5%'],font3)
    ...
    ax3.set_yticklabels(['0%','2.5%','5%'],font3)
