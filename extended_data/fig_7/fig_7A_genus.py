...
def four(ax_four):
    ...
    ax_four.set_yticks([300, 600, 900, 1200, 1500])
    ax_four.set_ylabel('Average Genus Index',font1)
    ax_four.set_yticklabels(ax_four.get_yticks(), font1)
    ax_four.set_xlabel('Year',font1)
    ax_four.set_xlim([1972,2017])
    ax_four.set_ylim([400, 1600])
    ...
    ax_four.text(1974, 400 + (1600 - 400) * 0.96, 'A', verticalalignment="top",
                horizontalalignment="left", fontdict=font3)
    ax_four.text(1978.5, 400 + (1600 - 400) * 0.95, 'At the taxonomic level of genus', verticalalignment="top",
