...
f = pd.read_csv(r'D:\VSCode\crawler\family_level_1446.csv')
...
ax.set_xlim([0,1000])
ax.set_xticks([150 * i for i in range(7)])
ax.set_xticklabels([150 * i for i in range(7)], font1)
ax.set_xlabel('Family Number',font1)
ax.set_yticks(y)
...
fig.savefig(r'chugao\fish_220114_re\figure2\extra\fig3_0805\figS6.pdf',dpi=300)
plt.show()