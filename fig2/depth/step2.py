...
median_df = pd.read_csv(r'fig2\depth\family_year_median_df.csv',index_col=(0))
print(median_df)
family = median_df[['family','level']].drop_duplicates()
family.reset_index(inplace=True)
fam = family['family'].drop_duplicates()
fam.to_csv(r'fig2\depth\FamilyNum_1.csv')
...
save_variable(median_array, r'fig2\depth\medianPoint.txt')
save_variable(count_array, r'fig2\depth\countArray.txt')
print(count_array)
...
family.to_csv(r'E:\gephi\data\vertex0.9_node_depth_230127.csv')
print(family)