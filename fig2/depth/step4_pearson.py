...
dffamily = pd.read_csv(r'fig2\depth\FamilyNum_1.csv')
...
save_variable(correlation,r'fig2\depth\correlation.txt')
save_variable(pvalue,r'fig2\depth\pvalue.txt')
save_variable(familyExtract,r'fig2\depth\familyExtract.txt')
