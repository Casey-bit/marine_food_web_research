...
medianPoint = load_variavle(r'fig2\depth\medianPoint.txt')
'''
计算需要保留下来的物种
'''
reserve = [] # 记录保留的物种
...
count_array = load_variavle(r'fig2\depth\countArray.txt')
...
save_variable(rank_result,r'fig2\depth\reserve.txt')
...
save_variable(medianPoint, r'fig2\depth\median_interpolation.txt')
...
save_variable(median_denoising, r'fig2\depth\median_denoising.txt')