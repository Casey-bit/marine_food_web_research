...
path = []
filePath = 'E:\\paper\\ftp\\cmems_mod_glo_bgc_my_0.25_P1M-m'
for dirpath, dirnames, filenames in os.walk(filePath):
    path = path + [os.path.join(dirpath, names) for names in filenames]

# print(nc.variables.keys())
# dict_keys(['longitude', 'latitude', 'depth', 'time', 'chl', 'no3', 'po4', 'si', 'o2', 'nppv', 'fe', 'spco2', 'ph', 'phyc'])

# res_df = pd.DataFrame({'year':[], 'month':[], 'depth':[], 'latitude':[], 'mean_chl':[]})
