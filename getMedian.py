...
latitudeByYear = load_variavle(r'chugao\fish_220114_re\cluster\latitudeByYear_1970_2020_2846_1.txt')

'''
计算每个物种每年的中值
'''
medianPoint = np.array([[0.0 for year in range(yearTotal)] for family in range(2846)]) # 每个物种每年的中值
...
save_variable(rank_result,r'chugao\fish_220114_re\correlation_median_point\reserve.txt')
...
median_denoising = np.array([[np.nan for year in range(yearTotal)] for family in range(2846)]) # 每个物种每年的中值
