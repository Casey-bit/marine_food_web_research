...
final_merge_df = pd.read_csv('Trophic2_q1.csv')
region_number=9;
period_time=5;
...
y = [1,0.88,0.76,0.64,0.52,0.35,0.15]
color = ['rgba(238,103,76,0.5)' for i in range(9)]

x += [0.25 for i in range(5)]
y += [0.76,0.64,0.52,0.35,0.15]
color += ['rgba(238,103,76,0.6)' for i in range(9)]

x += [0.4 for i in range(7)]
y += [0.88,0.76,0.64,0.55,0.35,0.18,0.09]
color += ['rgba(238,103,76,0.7)' for i in range(9)]

x += [0.55 for i in range(9)]
#y += [1,0.88,0.76,0.64,0.55,0.35,0.18,0.09,0.001]
y += [1,0.88,0.76,0.64,0.52,0.35,0.15,0.09,0.001]
