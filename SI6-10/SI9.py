...
final_merge_df = pd.read_csv('Trophic4_q0.csv')
region_number=9;
period_time=5;
...
x += [0.25 for i in range(6)]
y += [0.76,0.64,0.52,0.35,0.15,0.09]
...
x += [0.55 for i in range(5)]
y += [0.76,0.64,0.52,0.35,0.15]
color += ['rgba(238,103,76,0.8)' for i in range(9)]

x += [0.7 for i in range(6)]
y += [1,0.88,0.76,0.64,0.52,0.35]
