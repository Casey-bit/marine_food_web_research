...
def early_shift(ax):
    family_year_median_df = pd.read_csv(r'cluster\family_year_median_df_depth_early1990.csv', index_col=(0))
    ...
    label = ['Family shift downward (0m-30m)', 'Family shift upward (0m-30m)', 'Family shift downward (30m-100m)',
             'Family shift upward (30m-100m)', 'Family shift downward (>100m)', 'Family shift upward (>100m)']
    for i in range(1, 4):
    ...
    ax.legend(loc=1,prop=font2, fontsize=12, markerscale=0.5, columnspacing=0.5)
